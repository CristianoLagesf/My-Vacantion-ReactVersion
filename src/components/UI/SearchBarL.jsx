...
const SearchBarL = () => {
    ...
    return (
        <LocalizationProvider dateAdapter={AdapterMoment}>
            ...
            <div className="border-2 rounded-md w-80% max-w-[1100px] p-[10px] bg-white border-blue-10 mb-[30px]">
                <div className="grid ">
                    <div className=" flex justify-start max-w-[300px]">
                        <div>
                            <Button
                                id="basic-button"
                    ...
                    <div className="flex gap-x-7">
                        ...
                        {/* Departing & returning */}
                        <button className=" border-4 border-blue-10  bg-blue-10  mb-2
                        w-[100px] h-[40px] font-semibold uppercase rounded-md place-self-end  m-[5px]
